...
def get_bounding_box(event_map: gemmi.FloatGrid, coord: Coord, radius: float = 0.1, margin: float = 5.0) -> gemmi.FloatGrid:
    event_centroid = gemmi.Position(coord.x, coord.y, coord.z)
...
def truncate_xmap(xmap_path: Path, coords: Coord, out_dir: Path):
    ...
    print(bounding_box.minimum)
    print(bounding_box.maximum)
